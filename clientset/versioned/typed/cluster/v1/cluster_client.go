...
import (
	"github.com/feloy/operator/clientset/versioned/scheme"
...
// ClusterV1Client is used to interact with features provided by the cluster.anevia.com group.
type ClusterV1Client struct {
	restClient rest.Interface
}

func (c *ClusterV1Client) CdnClusters(namespace string) CdnClusterInterface {
	return newCdnClusters(c, namespace)
}
